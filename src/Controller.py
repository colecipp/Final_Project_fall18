...
class Controller:
    ...
    def gameLoop(self):
        ...
        while self.state == "GAME":
            ...
            if (pygame.time.get_ticks()-spawn_time)/1000 > 6:
                if self.powerup == "b":
                   powerupGroup.add(HealthPowerUp.HealthPowerUp(random.randint(100,600),random.randint(100,400),pathname("assets/HealthPowerUp.png")))
                elif self.powerup == "a":
                    powerupGroup.add(DamagePowerUp.DamagePowerUp(random.randint(100,600),random.randint(100,400),pathname("assets/DamagePowerUp.png")))
